		...
		<div id="container_box">
			...
			<input type="hidden" name="gdsnum" value="${goodsModify.gdsnum}" />
				...
				<div class = "inputArea">
					...
					<input type = "text" id = "gdsName" name = "gdsname" value="${goodsModify.gdsname}" />
				</div>
				
				<div class = "inputArea">
					<label for = "gdsPrice">상품 가격</label>
					<input type = "text" id = "gdsPrice" name = "gdsprice" value="${goodsModify.gdsprice}" />
				</div>
				
				<div class = "inputArea">
					<label for = "gdsStock">상품 수량</label>
					<input type = "text" id = "gdsStock" name = "gdsstock" value="${goodsModify.gdsstock}"/>
				</div>
				...
				<div class = "inputArea">
					<button class = "btn btn-primary" type = "submit" id = "btnUpdate">등록</button>
					<button class = "btn btn-warning" type = "button" id = "btnBack">취소</button>
					
					<script>
						$("#btnBack").click(function(){
							//history.back(); 뒤로가기 버튼
							location.href = "${pageContext.request.contextPath}/admin/goods/view?n=" + ${goodsModify.gdsnum};
						});
					</script>
				</div>
			</form>
...
<script>
	...
	var select_catecode = '${goodsModify.catecode}';
	var select_catecoderef = '${goodsModify.catecoderef}';
	var select_catename = '${goodsModify.catename}';
